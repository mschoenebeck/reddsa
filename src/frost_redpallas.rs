...
#[derive(Clone, Copy, PartialEq)]
/// An implementation of the FROST ciphersuite FROST(RedPallas, BLAKE2b-512).
...
impl Ciphersuite for PallasBlake2b512 {
    ...
    /// H1 for FROST(RedPallas, BLAKE2b-512)
    ...
    /// H2 for FROST(RedPallas, BLAKE2b-512)
    fn H2(m: &[u8]) -> <<Self::Group as Group>::Field as Field>::Scalar {
        HStar::<orchard::SpendAuth>::default().update(m).finalize()
    }

    /// H3 for FROST(RedPallas, BLAKE2b-512)
